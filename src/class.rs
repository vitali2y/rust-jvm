...
impl Class {
  ...
  pub fn get_method(&self, name: &str, signature: &str) -> Result<::Method, ::Object> {
    ...
    let handle =
      unsafe { (**env).GetMethodID.unwrap()(env, self.0, name.as_ptr(), signature.as_ptr()) };
  ...
  pub fn get_static_method(&self, name: &str, signature: &str) -> Result<::Method, ::Object> {
    ...
    let handle =
      unsafe { (**env).GetStaticMethodID.unwrap()(env, self.0, name.as_ptr(), signature.as_ptr()) };
  ...
  pub unsafe fn call_boolean_method(
    ...
    let result =
      (**env).CallStaticBooleanMethodA.unwrap()(env, self.0, method.as_handle(), args.as_ptr());
  ...
  pub unsafe fn call_byte_method(
    ...
    let result =
      (**env).CallStaticByteMethodA.unwrap()(env, self.0, method.as_handle(), args.as_ptr());
  ...
  pub unsafe fn call_short_method(
    ...
    let result =
      (**env).CallStaticShortMethodA.unwrap()(env, self.0, method.as_handle(), args.as_ptr());
  ...
  pub unsafe fn call_int_method(
    ...
    let result =
      (**env).CallStaticIntMethodA.unwrap()(env, self.0, method.as_handle(), args.as_ptr());
  ...
  pub unsafe fn call_long_method(
    ...
    let result =
      (**env).CallStaticLongMethodA.unwrap()(env, self.0, method.as_handle(), args.as_ptr());
  ...
  pub unsafe fn call_float_method(
    ...
    let result =
      (**env).CallStaticFloatMethodA.unwrap()(env, self.0, method.as_handle(), args.as_ptr());
  ...
  pub unsafe fn call_double_method(
    ...
    let result =
      (**env).CallStaticDoubleMethodA.unwrap()(env, self.0, method.as_handle(), args.as_ptr());
  ...
  pub unsafe fn call_object_method(
    ...
    let handle =
      (**env).CallStaticObjectMethodA.unwrap()(env, self.0, method.as_handle(), args.as_ptr());
